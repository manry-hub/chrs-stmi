        ...
        <div className="min-h-screen bg-slate-50 py-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-2xl mx-auto mb-12">
                    <h1 className="text-3xl font-bold text-slate-900 flex items-center justify-center gap-3">Daftar Hazard Kampus</h1>
                    <p className="mt-4 text-slate-500">
                        Berikut adalah daftar laporan hazard yang telah dikirimkan oleh civitas akademika. Semua laporan bersifat transparan untuk
